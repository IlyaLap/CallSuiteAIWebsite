      ...
      <div className="container-wide flex flex-col-reverse lg:flex-row items-center py-16 md:py-24">
        ...
        <div className="w-full lg:w-1/2 pt-10 lg:pt-0">
          <div className="animate-fade-in">
            <h1 className="heading-xl text-darkSlate mb-6" data-sb-field-path="headline">
              Never Miss Another Call. <span className="text-primary">Book More Jobs.</span> Zero Hassle.
            </h1>
            
            <p className="text-xl text-gray-600 mb-8" data-sb-field-path="subheadline">
              The AI phone assistant built specifically for service professionals
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 mb-10">
              <Button onClick={scrollToCTA} className="btn-primary text-slate-50" data-sb-field-path="primaryCTA">
                Schedule Your Free Demo
              </Button>
              <Button variant="outline" className="text-lg gap-2" onClick={navigateToHowItWorks} data-sb-field-path="secondaryCTA">
                See How It Works
              </Button>
            </div>
          </div>
        ...
        <div className="w-full lg:w-1/2 lg:pl-12">
          <div className="relative aspect-video bg-black/5 rounded-lg shadow-xl overflow-hidden" data-sb-field-path="videoEmbed">
            <iframe 
